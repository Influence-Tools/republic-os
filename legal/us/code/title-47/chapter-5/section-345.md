...
type: "LegalText"
title: "47 U.S.C. § 345"
description: "Protection of survivors of domestic violence, human trafficking, and related crimes"
jurisdiction: "us"
...
(2) Covered act (A) In general The term “covered act” means conduct that constitutes—
...
(c) Line separation request (1) In general In the case of a survivor seeking to separate a line from a shared mobile service contract, the survivor shall submit to the covered provider a line separation request that—
...
(f) Technical infeasibility (1) In general The requirement to effectuate a line separation request pursuant to subsection (b)(1) shall not apply to a covered provider if the covered provider cannot operationally or technically effectuate the request.
...
(g) Liability protection (1) In general A covered provider and any officer, director, employee, vendor, or agent thereof shall not be subject to liability for any claims deriving from an action taken or omission made with respect to compliance with this section and the rules adopted to implement this section.
