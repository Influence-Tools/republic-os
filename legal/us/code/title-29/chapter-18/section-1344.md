...
(d) Distribution of residual assets; restrictions on reversions pursuant to recently amended plans; assets attributable to employee contributions; calculation of remaining assets (1) Subject to paragraph (3), any residual assets of a single-employer plan may be distributed to the employer if—
...
(f) Valuation of section 1362(c) liability for determining amounts payable by corporation to participants and beneficiaries (1) In general In the case of a terminated plan, the value of the recovery of liability under section 1362(c) of this title allocable as a plan asset under this section for purposes of determining the amount of benefits payable by the corporation shall be determined by multiplying—
